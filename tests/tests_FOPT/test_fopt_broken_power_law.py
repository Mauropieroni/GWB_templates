...
model = get_template_from_registry("FoptBrokenPowerLaw")
bpl_fs = get_template_from_registry("BrokenPowerLawFixedSmoothness")
...
class TestFoptBrokenPowerLawTemplate(unittest.TestCase):
    ...
    def test_matches_broken_power_law_fixed_smoothness(self):
        ...
        out_fopt = model.omega_gw_h2(fvec, *PARS)
        out_bpl_fs = bpl_fs.omega_gw_h2(fvec, *PARS)
