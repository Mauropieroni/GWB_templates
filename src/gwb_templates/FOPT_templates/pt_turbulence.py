r"""
MHD-turbulence contribution to the GW spectrum from a cosmological first-order phase
transition.

Based on:

A. Roper Pol, C. Caprini, A. Neronov, and D. Semikoz, "Gravitational wave signal from
primordial magnetic fields in the Pulsar Timing Array frequency band", Phys.Rev.D 105
(2022) 12; [arXiv:2201.05630 [astro-ph.CO]].

Also see: A. Kosowsky, A. Mack and T. Kahniashvili, "Gravitational radiation from
cosmological turbulence", Phys.Rev.D 66 (2002) 024030; [arXiv:astro-ph/0111483] and C.
Caprini, R. Durrer and G. Servant, "The stochastic gravitational wave background from
turbulence and magnetic fields generated by a first-order phase transition", JCAP 12
(2009) 024; [arXiv:0909.0622 [astro-ph.CO]] (foundational MHD-turbulence GW spectrum
derivations).
"""
...
class PtTurbulence(AnalyticTemplate):
    ...
    ---------------
    log_Omega_s
        :math:`\log_{10}` of the fractional energy density in the turbulent source.
    log_R_H_star
    ...
    transition_smoothness_low_f
        ...
        slopes. Defaults to `PtTurbulence.DEFAULT_SPECTRAL_EXPONENTS[3]`.
    ...
    DEFAULT_AMPLITUDE_PREFACTOR: ClassVar[jax.Array] = jnp.array(0.085)
    #: Eddy-turnover scaling N_eddy.
    N_EDDY: ClassVar[jax.Array] = jnp.array(2.0)
    ...
    DEFAULT_MODEL_NAME: ClassVar[str] = "pt_turbulence"
    DEFAULT_MODEL_LABEL: ClassVar[str] = "PT MHD Turbulence"
